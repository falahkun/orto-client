...
import { Activity, Plus, PlayCircle, Calendar, Trophy, Loader2, ArrowLeft, Users } from 'lucide-react';
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-500 md:p-10">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-muted-text font-bold text-lg italic tracking-tight">Semua sesi permainan untuk komunitas ini.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="sport-card p-6 md:col-span-2 flex flex-col justify-center items-start border-primary/20 bg-primary-light/10">
          ...
          <p className="text-muted-text font-bold text-sm">Total {sessions.length} sesi telah dimainkan di komunitas ini. Pantau performa setiap anggota dan riwayat pertandingan secara berkala.</p>
        </div>
      </div>
      ...
      <section className="sport-card overflow-hidden">
        <div className="px-8 py-6 border-b-2 border-sport-border bg-app-bg flex items-center gap-4">
          ...
          <h2 className="font-black text-2xl tracking-tight uppercase italic text-app-text">Sesi Permainan</h2>
        </div>
